...
if(isset($_POST['create_post'])){
    ...
    $post_image1=$_FILES['post_jpg']['name'];
    $post_image_temp1=$_FILES['post_jpg']['tmp_name'];

    move_uploaded_file($post_image_temp,"upload/.$post_image");
    move_uploaded_file($post_image_temp1,"image/.$post_image1");

    		// Now let's Insert the video path into database
            $query = "INSERT INTO posts(Url,Artist,language,post_image) VALUES('{$post_image}','{$artist}','{$lang}','{$post_image1}')";
...
<body style ="background: linear-gradient(180deg, #404AA0 0%, rgba(30, 62, 87, 0.94) 100%);">
...
<input type="file" name="post_jpg" class="form-control" accept=".png" title="Image"/>
